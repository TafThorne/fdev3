...
This is a Dockerfile that generates a Docker Image based on the Offical Golang
Image with openjfx and a few other tools added.
The extras installed are detailed in the README.md

## How Can I Contribute?

### Reporting Bugs

Please file a bug under the fdev3 GitHub project.  Make sure to describe what
...
Please ensure that you build a Docker Image to test your new Dockerfile:
  docker build -t tafthorne/fdev3 -f ./Dockerfile .
